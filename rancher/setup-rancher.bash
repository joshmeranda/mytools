...
Args
  ...
  --agents, -a  <int>  Specify how many rancher agent clusters to start, kubeconfigs will be generated in the current directory following the pattern '$cluster_prefix-agent-<n>.yaml' [$agents]
